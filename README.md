...
Перед созданием нового проекта необходимо выполнить инструкцию по установке JDK и переменных окружения

После этого можно переходить к созданию проекта
...
7. Создайте в проекте issue, к которому приложите отчёты. В личном кабинете вам нужно будет отправить ссылку на тот issue, что вы создали для демонстрационного проекта: netology-code/aqa-hw-sample#1.